...
[benchmark-agent] → get_ethtool_info("10.1.37.12", "eno16695np0", active_only=True)
...
[review-agent] → get_ethtool_info("10.1.37.14", "eno16695np0", mode="stats", pattern="rx_(errors|missed)|tx_errors")
```
